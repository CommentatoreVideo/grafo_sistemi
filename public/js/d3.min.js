!(function () {
	...
	function mr(n, t) {
		var e,
			...
			a = [],
			l = [];
		for (n += "", t += ""; (e = hl.exec(n)) && (r = pl.exec(t)); ) (i = r.index) > u && ((i = t.slice(u, i)), a[o] ? (a[o] += i) : (a[++o] = i)), (e = e[0]) === (r = r[0]) ? (a[o] ? (a[o] += r) : (a[++o] = r)) : ((a[++o] = null), l.push({ i: o, x: yr(e, r) })), (u = pl.lastIndex);
		return (
			...
			return (
				(l.tick = function () {
					...
					var t,
						...
						_ = M.length,
						w = x.length;
					for (r = 0; w > r; ++r) (l = x[r]), (h = l.source), (p = l.target), (m = p.x - h.x), (b = p.y - h.y), (v = m * m + b * b) && ((v = (i * o[r] * ((v = Math.sqrt(v)) - u[r])) / v), (m *= v), (b *= v), (p.x -= m * (y = h.weight + p.weight ? h.weight / (h.weight + p.weight) : 0.5)), (p.y -= b * y), (h.x += m * (y = 1 - y)), (h.y += b * y));
	...
	(ao.layout.histogram = function () {
		...
		(ao.layout.tree = function () {
			...
			function t(n) {
				for (var t, e = { A: null, children: [n] }, r = [e]; null != (t = r.pop()); ) for (var i, u = t.children, o = 0, a = u.length; a > o; ++o) r.push(((u[o] = i = { _: u[o], parent: t, children: ((i = u[o].children) && i.slice()) || [], A: null, a: null, z: 0, m: 0, c: 0, s: 0, t: null, i: o }).a = i));
				return e.children[0];
			}
			function e(n) {
				var t = n.children,
	...
	ao.svg.brush = function () {
		...
		return (
			...
			(n.extent = function (t) {
				var e, r, i, u, l;
				return arguments.length
					? (c && ((e = t[0]), (r = t[1]), f && ((e = e[0]), (r = r[0])), (o = [e, r]), c.invert && ((e = c(e)), (r = c(r))), e > r && ((l = e), (e = r), (r = l)), (e == s[0] && r == s[1]) || (s = [e, r])), f && ((i = t[0]), (u = t[1]), c && ((i = i[1]), (u = u[1])), (a = [i, u]), f.invert && ((i = f(i)), (u = f(u))), i > u && ((l = i), (i = u), (u = l)), (i == h[0] && u == h[1]) || (h = [i, u])), n)
